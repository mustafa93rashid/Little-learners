  ...
  return (
    <nav className="px-50">
      ...
      <div className="MR-nav1Container ">
        ...
        <img src="/Little-learners/Navbar/Icon.svg" alt="" />

        {/* Decorative shape positioned at the top left */}
        <img
          className="MR-nav1Shape1"
          src="/Little-learners/Navbar/Abstract Design.svg"
          alt=""
        />
        <img
          className="MR-nav1Shape2"
          src="/Little-learners/Navbar/Abstract Design (1).svg"
          alt=""
        />
        <img
          className="MR-nav1Shape3"
          src="/Little-learners/Navbar/Abstract Design (2).png"
          alt=""
        />
        <img
          className="MR-nav1Shape4"
          src="/Little-learners/Navbar/Abstract Design (3).png"
          alt=""
        />
      </div>
    </nav>
